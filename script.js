...
function setTheme(theme) {
  ...
  if (musicTitle) {
    musicTitle.textContent =
      theme === "dark" ? "Lo-fi Piano Lounge" : "Soft Café Jazz";
  }
}
...
const menuItems = [
  ...
  },
  {
    ...
    price: "₹150",
    image:
      "https://t4.ftcdn.net/jpg/15/63/81/65/360_F_1563816517_bdi5Y437rIEY0GPmvPQnUdUuFJ18Fyty.jpg",
  ...
  },
  {
    ...
    price: "₹175",
    image:
      "https://images.unsplash.com/photo-1633933358116-a27b902fad35?w=600&q=80",
...
lightboxEl.addEventListener("click", (e) => {
  if (e.target === lightboxEl || e.target.classList.contains("lb-img-wrap"))
    closeLightbox();
});
...
function goToReview(index) {
  ...
  if (!card) return;
  // Compute gap from CSS (16px mobile, 20px tablet, 24px desktop)
  const gap =
    window.innerWidth >= 768 ? 24 : window.innerWidth >= 640 ? 20 : 16;
